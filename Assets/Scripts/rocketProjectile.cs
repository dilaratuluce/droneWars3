...
public class rocketProjectile : MonoBehaviour
{
    ...
    {
        if (!collision.transform.tag.Equals(TagHolder.player) && !collision.transform.tag.Equals(TagHolder.unshootable) && !collision.transform.tag.Equals(TagHolder.untagged))
        {
